<?php
 return array (
  ...
  'certificate required' => 'Certificate Registration is required',
  'bank required' => 'Bank Statement is required',
  'article required' => 'Articles of Incorporation is required',
  'valid certificateRegistration' => 'Certificate Registration file must be a pdf',
  'valid bankStatement' => 'Bank Statement file must be a pdf',
  'valid articlesOfIncorporation' => 'Articles of Incorporation must be a pdf',
  'ID Card required' => 'ID Card Required',
  'ID Card Types' => 'ID Card must be an image',
